...
\restrict cFR4vfuB5devSWY1Ybj073W4XtXgjVH9Mp9x00I4ROePveMAX5CdkGaF0QBuss3
...
--
-- Name: meme_concepts; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.meme_concepts (
    id integer NOT NULL,
    fact text NOT NULL,
...
--
-- Name: meme_concepts_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.meme_concepts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: meme_concepts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: saved_carousels; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: saved_carousels_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.saved_carousels_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: saved_carousels_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: saved_scripts; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: saved_scripts_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.saved_scripts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: saved_scripts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: social_cards; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: social_cards_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.social_cards_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: social_cards_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: meme_concepts id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: saved_carousels id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: saved_scripts id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: social_cards id; Type: DEFAULT; Schema: public; Owner: -
--
...
COPY public.leads (id, name, email, phone, age_range, dependents, has_insurance, biggest_concern, timeline, utm_source, utm_medium, utm_campaign, status, created_at, quiz_type, coverage_amount, health, tobacco, monthly_budget, household_income) FROM stdin;
\.


--
-- Data for Name: meme_concepts; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.meme_concepts (id, fact, category, template, top_text, bottom_text, caption, platform, is_used, is_favorite, created_at, text_boxes) FROM stdin;
\.


--
-- Data for Name: saved_carousels; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.saved_carousels (id, title, caption, call_to_action, hashtags, topic, tone, dnd_themed, fact, slides, created_at) FROM stdin;
...
--
-- Data for Name: social_cards; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.social_cards (id, format, tone, dnd_themed, cards, created_at) FROM stdin;
\.
...
--
-- Name: meme_concepts_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: saved_carousels_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: saved_scripts_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: social_cards_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: meme_concepts meme_concepts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.meme_concepts
    ADD CONSTRAINT meme_concepts_pkey PRIMARY KEY (id);


--
-- Name: saved_carousels saved_carousels_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.saved_carousels
    ADD CONSTRAINT saved_carousels_pkey PRIMARY KEY (id);


--
-- Name: saved_scripts saved_scripts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.saved_scripts
    ADD CONSTRAINT saved_scripts_pkey PRIMARY KEY (id);


--
-- Name: social_cards social_cards_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.social_cards
    ADD CONSTRAINT social_cards_pkey PRIMARY KEY (id);
...
\unrestrict cFR4vfuB5devSWY1Ybj073W4XtXgjVH9Mp9x00I4ROePveMAX5CdkGaF0QBuss3
