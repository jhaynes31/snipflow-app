...
export const GUILD_CONFIG = {
  ...
  /** Flagged on their own, or when offered as the recruit's role. John's exact second title, "Pre-Certified Financial Advisor", passes; a bare "financial advisor" implies a registered advisor. */
...
export const GUILD_FACT_FIELDS: FactField[] = [
  ...
  { key: "roleTitle", label: "Role title", help: "The name of the role a recruit starts in, which is what a new recruit actually is on day one. John's own titles are set separately and used exactly. Investment Adviser and Certified Financial Planner are legally protected; leave those out. The flyer says \"Remote Financial Services Positions\".", tier: "trust", required: true, multiline: false, usedIn: "Hero" },
