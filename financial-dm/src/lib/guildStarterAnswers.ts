 ...
 *
 * John keeps the startup costs for the interview (Jen, 12 Sep 2026), so
 * recruitCosts and investmentPathExists are optional and left blank.
 * A row still holding one of the "TODO(John)" drafts below is replaced.
 */
export const GUILD_STARTER_ANSWERS: Array<{ key: string; value: string; confirmed: boolean }> = [
  ...
  // Fair questions, relayed the same day.
  ...
  { key: "faq_costs", value: "Interviewing costs nothing, and you will never be asked for payment or financial information to interview. Getting started does have costs, which you pay yourself, and I go through exactly what they are in the interview.", confirmed: true },
  { key: "statesServed", value: "Based on the licenses you hold.", confirmed: true },
