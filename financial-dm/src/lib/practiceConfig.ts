...
export const DIFFICULTY_LEVELS: DifficultyLevel[] = [
  ...
  { level: 2, name: "Realistic", summary: "Occasional interruptions, needs a term explained, short answers until John earns more.", behavior: "Interrupt occasionally, ask for one term to be explained in plain words, get briefly distracted once, and give short answers until John has earned more by asking about you.", interruptionRate: 0.25 },
