...
/**
 * The how-to for the DM Screen, presenting, the Sparring Dummy, and recruit
 * access, one topic at a time for the How To tab. Plain English, no scores,
 * no jargon. The few numbers come from the same config the tools read, so
 * they never drift. Topic ids match src/lib/howTo.ts.
 */

const card = "rounded-xl border border-[#406080]/30 bg-[#111a28] p-4 sm:p-5 space-y-3";
...
const tile = "rounded-lg border border-[#406080]/30 p-3 space-y-1";

const levels = DIFFICULTY_LEVELS;

/** Each topic renders on its own. */
export const TOOL_TOPICS: Record<string, () => ReactNode> = {
  "screen-writing": () => (
    <section className={card} data-guide-section="screen-writing">
      <h2 className={h2}>📜 Writing a script</h2>
      ...
      <p className={note}>While a presenter window of the same script is open, autosave pauses so nothing changes under you mid-presentation. A Save now button appears if you mean it.</p>
    </section>
  ),
  "screen-format": () => (
    <section className={card} data-guide-section="screen-format">
      <h2 className={h2}>📜 Bold, italic, and bullets</h2>
      ...
      <p className={small}>Nothing else: no colours, images, or fonts. Each line is its own paragraph on the presenter view.</p>
    </section>
  ),
  "screen-history": () => (
    <section className={card} data-guide-section="screen-history">
      <h2 className={h2}>📜 History, duplicates, and archive</h2>
      <div className="grid gap-3 sm:grid-cols-2">
        <div className={tile}>
          <h3 className={h3}>Never lost</h3>
          <p className={p}>Every save is kept. Press <b>History</b> to see the last {DM_SCREEN_CONFIG.versionsKept} and restore any of them. Restoring keeps what is there now as a version too.</p>
        </div>
        <div className={tile}>
        ...
        <div className={tile}>
          <h3 className={h3}>No delete</h3>
          <p className={p}>Scripts are never deleted. <b>Archive</b> puts one away; the "Archived scripts" link at the bottom of the list shows it with a <b>Bring back</b> button.</p>
        </div>
        <div className={tile}>
          <h3 className={h3}>Edited in two places</h3>
          <p className={p}>If the same script is saved from another window, the editor stops and offers <b>Load the newer copy</b> rather than overwrite anything.</p>
        </div>
      </div>
    </section>
  ),
  "screen-flags": () => (
    <section className={card} data-guide-section="screen-flags">
      <h2 className={h2}>📜 Warnings and Trust tags</h2>
      <div className="grid gap-3 sm:grid-cols-2">
        <div className={tile}>
          <h3 className={h3}>Things to check</h3>
          <p className={p}>As you type, phrases that could cause trouble get a small warning under the section: guarantees in client scripts, income claims and hiring language in recruit scripts. They never stop you saving. Fix the words and the warning goes. The same warnings show once more on the screen before you start presenting, and never during.</p>
        </div>
        <div className={tile}>
          <h3 className={h3}>Trust and Presentation tags</h3>
          <p className={p}>In recruit scripts each section can be marked <b>Trust fact</b> (safe to say anywhere) or <b>Presentation fact</b> (for the conversation). It shows as a small label in the editor and beside the title while presenting. A label for you, nothing more.</p>
        </div>
      </div>
    </section>
  ),
  present: () => (
    <section className={card} data-guide-section="present">
      <h2 className={h2}>🎤 Presenting from two monitors or the phone</h2>
  ...
  "present-keys": () => (
    <section className={card} data-guide-section="present-keys">
      <h2 className={h2}>🎤 Keys and the remote</h2>
      ...
      <p className={small}>Clicking the right two thirds of the words also advances; the left third goes back. The buttons at the bottom do the same.</p>
    </section>
  ),
  "dummy-setup": () => (
    <section className={card} data-guide-section="dummy-setup">
      <h2 className={h2}>🥊 Setting up a practice session</h2>
  ...
  "dummy-during": () => (
    <section className={card} data-guide-section="dummy-during">
      <h2 className={h2}>🥊 During the session and the debrief</h2>
      <div className="grid gap-3 sm:grid-cols-2">
        <div className={tile}>
  ...
  "dummy-rubric": () => (
    <section className={card} data-guide-section="dummy-rubric">
      <h2 className={h2}>🥊 Your rubric and past sessions</h2>
      <div className="grid gap-3 sm:grid-cols-2">
        <div className={tile}>
  ...
  recruits: () => (
    <section className={card} data-guide-section="recruits">
      <h2 className={h2}>🛡️ Giving a recruit practice access</h2>
