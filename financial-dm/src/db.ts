...
export const sql = () => {
  ...
  // Harden the connection string against stray quotes or surrounding whitespace
  // (e.g. a value stored with literal "..." around it on the host). neon() rejects
  // such strings as "not a valid URL", so trim and strip one layer of matching
  // quotes before handing the string to the driver.
