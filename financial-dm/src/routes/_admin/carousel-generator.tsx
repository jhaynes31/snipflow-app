...
export const Route = createFileRoute("/_admin/carousel-generator")({
  component: CarouselGeneratorPage,
});

function CarouselGeneratorPage() {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#a0a0a0] text-xs font-fantasy mt-2">
            John only: Roll a topic and forge a financial slideshow to post
          </p>
        </div>
        ...
        {tab === "forge" ? <CarouselGenerator /> : <SavedCarousels />}
