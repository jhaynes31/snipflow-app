...
function ChangePasswordPage() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-md rounded-xl border border-[#406080]/30 bg-[#111a28] p-6 space-y-4">
        ...
        {done ? (
          <div className="space-y-3 text-center">
            ...
            <a href="/dashboard" className="inline-block px-4 py-2 rounded-lg bg-[#c08020] hover:bg-[#a06a18] text-[#0d1520] font-bold font-fantasy text-sm transition-all">
      ...
      <a href="/dashboard" className="mt-8 text-[#606080] hover:text-[#a0a0a0] text-xs font-fantasy transition-colors">
