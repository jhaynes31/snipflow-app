...
The four first modules are Every Box, Tend (the support app), the fitness module (display name "Fitness" until its final name is chosen), and Love & Release. Module display names come only from each module's manifest.
