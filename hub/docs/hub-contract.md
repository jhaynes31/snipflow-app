...
| 9. The Apothecary *(built 2026-09-23)* | Its own place, from docs/apothecary-spec.md | An ask saves an entry and gets the six-part answer; the daily line and patterns work; Where to go points at real finders |
