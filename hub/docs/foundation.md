...
| `convex/tend/`, `modules/tend/` | Tend: check-in vocabulary and functions on the Convex side; the check-in flow (served at `/check-in`), guidance cards, Love Menus, and "my manual" screens on the module side. |
