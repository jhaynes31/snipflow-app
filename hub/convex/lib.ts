...
export async function requireOwned<
  T extends "userManualSections" | "headsUps" | "checkIns" | "coachConversations" | "safetyPlans" | "tendGuidance" | "tendLoveMenu" | "tendLoveActions" | "tendToolUses" | "tendLoops" | "tendEvidence" | "tendProjects" | "tendFocusSessions" | "tendCycleStarts" | "tendSleep" | "tendRepairs" | "tendNotes",
>(
  ctx: Ctx,
  me: Me,
  table: T,
