...
export const STORIES: StoryOption[] = [
  ...
  { text: 'I have to fix this', tags: ['Setting a boundary', 'Pressure to perform or prove myself', 'Compassion fatigue'] },
  { text: "I can't say that to them", tags: ['Conflict & hard conversations', 'Setting a boundary'] },
  { text: "I'm overreacting", tags: ['Handling emotions', 'Naming poor behavior'] },
  { text: "I'm too tired to care anymore", tags: ['Compassion fatigue', 'Needing rest'] },
