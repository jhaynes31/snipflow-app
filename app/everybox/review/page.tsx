...
import { Btn, ErrorNote, PageTitle, Spinner, useAction } from "@/components/everybox/ui";
    ...
    <div className="eb-container max-w-xl">
      ...
      {finished ? (
        <div className="eb-card eb-fade-in text-center">
          ...
          <Link href="/everybox" className="eb-btn eb-btn-primary mt-4">
        ...
        <div className="eb-card text-center">
          ...
          <Link href={pending.totalCategories === 0 ? "/everybox/categories" : "/everybox"} className="eb-btn eb-btn-secondary mt-4">
        ...
        <div className="eb-card eb-fade-in" key={current.category._id}>
          ...
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <div>
              ...
              <div className="text-xs eb-muted">tended by {partnerName(partners, current.category.tenderId, partner._id)}</div>
            </div>
