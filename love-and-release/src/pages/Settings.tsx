...
export function SettingsPage() {
  ...
  return (
    <Shell back="/" title="Settings">
      ...
      <Confirm open={confirmReset} title="Reset everything?" body="This removes all your data from this device and can't be undone." confirmLabel="Yes, reset" onCancel={() => setConfirmReset(false)} onConfirm={async () => { await resetEverything(); window.location.href = '/' }} />
